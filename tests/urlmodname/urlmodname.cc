...
#include "gxdeps/github.com/gx-org/ccgx/tests/urlmodname/urlmodname.h"
...
using github_com::gx_org::ccgx::tests::urlmodname::Urlmodname;
...
int main() {
  ...
  auto package(Urlmodname::BuildFor(device.value()));
  if (!package.ok()) {
